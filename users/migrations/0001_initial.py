    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', cloudinary.models.CloudinaryField(max_length=255, verbose_name='users/profile')),
                ('email', models.EmailField(default='default@example.com', max_length=254, unique=True)),
                ('first_name', models.CharField(max_length=30)),
                ('last_name', models.CharField(max_length=30)),
                ('phone', models.CharField(blank=True, max_length=35, null=True, unique=True)),
                ...
                ('business_image', cloudinary.models.CloudinaryField(blank=True, max_length=255, null=True, verbose_name='business/images')),
